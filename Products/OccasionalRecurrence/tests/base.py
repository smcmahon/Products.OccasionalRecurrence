...
def setup_product():
    ...
    import Products.OccasionalRecurrence
    zcml.load_config('configure.zcml', Products.OccasionalRecurrence)
    ...
    ztc.installPackage('Products.OccasionalRecurrence')
...
setup_product()
ptc.setupPloneSite(products=['Products.OccasionalRecurrence'])
